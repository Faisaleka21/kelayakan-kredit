const App = (() => {
  ...
  const renderTopbar = (session) => {
    ...
    topbar.innerHTML = `
      <div style="display: flex; align-items: center; gap: 12px;">
        <button class="menu-toggle" data-action="toggle-menu" style="background:none; border:none; padding:0; cursor:pointer; color: inherit;">
      ...
      <div class="login-wrapper">
        ...
        <div class="login-card glass">
          <div class="login-header">
            <h2 class="animate-title">Masuk</h2>
            <p class="helper-text animate-subtitle">Silakan login menggunakan akun admin atau manager.</p>
          </div>
          <form id="login-form" class="grid animate-form">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="action-row">
                        ...
                        <button class="btn" data-action="lihat" data-id="${
                          item.id
                        }">Lihat</button>
                      </div>
                    </td>
  ...
  const handleContentClick = (event) => {
    ...
    if (toggleBtn) {
      ...
      const sidebarEl = document.getElementById("sidebar") || sidebar; // Fallback to global
    ...
    if (target.matches(".sidebar-overlay")) {
      const sidebarEl = document.getElementById("sidebar") || sidebar;
    ...
    if (target.matches("[data-action='lihat']")) {
      const id = target.dataset.id;
      window.location.hash = `#proses?id=${id}`;
      return;
    }
